...
num_inducing_pts = 50           # Number of inducing points in each hidden layer
...
class MultitaskDeepGP(DeepGP):
    def __init__(self, train_x_shape, num_inducing_pts):
...
model = MultitaskDeepGP(train_x.shape,num_inducing_pts=num_inducing_pts)
